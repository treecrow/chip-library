...
;// CONCATENATED MODULE: ./src/popup/components/HcaptchaButton/index.tsx


function HcaptchaButton() {
    const openHomePage = () => {
        chrome.tabs.create({ url: 'https://www.hcaptcha.com/privacy-pass' });
    };
    return (react.createElement(PassButton, { value: 0, onClick: openHomePage }, "hCaptcha"));
}
...
const package_namespaceObject = {"i8":"3.0.2"};
...
function App() {
    return (react.createElement("div", { className: App_styles_module.app },
        ...
        react.createElement(Container, null,
            ...
            react.createElement(HcaptchaButton, null),
